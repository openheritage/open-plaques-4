...
Devise.setup do |config|
  ...
  # config.secret_key = 'df20e9510c921f08b2be7580d346777aa998e326db127508bd7963387e24c3a534c771039cf1dbd8a1048a6401f4486d2b9859a0f71f39e06a1a7d5920b71cbe'
  ...
  config.mailer_sender = "openplaques.dev@example.com"
  if Rails.env.test?
    config.mailer_sender = "openplaques.test@example.com"
  elsif Rails.env.production?
    config.mailer_sender = "openplaques.prod@example.com"
  end
  ...
  # config.pepper = '7e65265e9ed419c41ea33f9aff23887b8396facac8a5ab04725815ce1eda1ea5ad5c0b7a81e0c306311c676f4c3f1d6280e1b895264f516ceae231c16f9c3d18'
  ...
  # ==> Masquerade configuration (admin can login-as)
  Devise.masquerade_param = "token"
