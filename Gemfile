...
gem "interactor-rails", "~> 2.0" # To define business logic
...
gem "wikimedia-commoner", github: "jnicho02/wikimedia-commoner", branch: :main # the 'missing' API for Wikimedia Commons images
